...
**Your market is Brazil.** One market per team. You own it.
...
## 3. Your market: BRAZIL 🇧🇷

**Why Brazil.** An emerging, fast-growing wine market with a **large Italian-heritage population**, concentrated in São Paulo and the South, and an aspirational premium on-trade in São Paulo and Rio.

**How the market works**

* **Importer is essential.**
* **On-trade** (Italian restaurants, churrascarias and steakhouses), **premium retail** (St Marche, Grand Cru), and a fast-growing **e-commerce** channel (Wine.com.br, Evino).

**The consumer**

* The palate historically favoured softer, fruitier styles, but the market is **premiumizing**.
* **Chile, Argentina and Portugal dominate on price and proximity.** You cannot win on price. You compete on authenticity, heritage and food.
* The **Italian-heritage narrative lands harder here than anywhere else on the list.**
...
| Item                      | Brazil                                    |
| ------------------------- | ----------------------------------------- |
| **Freight & insurance**   | **€0.70** — the highest of any market     |
| **Import duty / taxes**   | **55% of landed value**                   |
...
*The 25,000 bottles is management's view of what the market could absorb in Year 1, not a stock figure. These are Elena's targets, not facts. If your analysis says they are wrong for Brazil, say so and show her why. Of all five markets, yours is the one where the arithmetic is most likely to tell you the board is wrong.*
...
**2. One generated image.** A **positioning visual for Brazil**: the single image you would put in front of a local importer, buyer or consumer to win the business. Label concept, campaign visual, gift pack, tasting-event key visual, your choice. It has to work in *Brazil*, not in Tuscany. Put it in the deck.
...
> ⚠ **One extra instruction for your team.** When you build the price ladder, make Copilot show the **order of operations** explicitly: landed value first, then the 55%, then importer, distributor and retail on top. It is very easy to get a table that looks perfectly reasonable and is wrong by a factor of two. Check it by hand once.
...
| 2 | **Positioning visual**            | One generated image (`.png` / `.jpg`), placed in the deck            | It would work in front of an importer, buyer or consumer **in Brazil**, not in Tuscany                                                                                                                                                                             |
...
5. **A strategy pack with your recommendations for Brazil.** The moves you would make, in priority order: route to market and the partner you want, pricing and positioning, the story you lead with, the launch activity, and how the €120,000 is split between them. For each one, say why it fits Brazil and what Elena has to decide. Close with a clear call: **go, go with conditions, or not yet**, and the conditions.

### 9.3 Indicative 8-slide deck structure

A shape that works. Not a rule. Adapt it to the Brazilian story.
...
| 3     | **What the market pays for a bottle**        | The price ladder: ex-cellar → freight → **55% on landed value** → importer → distributor → retail. Finish on the shelf price **in BRL**                  |
...
| 7     | **The positioning visual**                   | Your generated image, plus one line on why it works in Brazil                                                                                           |
